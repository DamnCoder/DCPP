...
namespace dc
{
	 ...
	 * @return
	 */
	bool CSkinLoader::importSkin(tModel* pModel, const std::string& path, const std::string& pattern)
	{
		SkinMap skins;
	 ...
	 * @return
	 */
	bool CSkinLoader::loadSkin(tModel* pModel, tSkin* skin, const std::string& path, const std::string& type)
	{

...
namespace dc
{
	...
	public:
		...
		math::Vector3f*	pVerts;			// Vertices de la malla a lo largo de todos los frames de animacion
		math::Vector3f*	pNormals;		// Normales de la malla a lo largo de todos los frames de animacion
		math::Vector3f*	pTexVerts;		// Coordenadas de textura
		tFace* 			pFaces;			// Caras que forman la malla

		math::Vector3f*	drawVertArray;
		math::Vector3f*	drawNormArray;
